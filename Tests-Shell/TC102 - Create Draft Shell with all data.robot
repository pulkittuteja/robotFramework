...
*** Test Cases ***
TC102 - Create Draft Shell with all data
    ...
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST ACCOUNT/CLIENT Link}/following-sibling::ul//a[@title='Salesforce Account']
    ...
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST ERA CREATE img}
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST ERA LINK img}
    Run Keyword And Continue On Failure    Element Should Not Be Visible    ${ASSIST ERA UNLINK img}
    Expand Assistant Section    ${ASSIST BUDGETS Link}
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST BUDGETS Link}/following-sibling::ul//a[@title='${shell_dict["Opp/EngName"]}']
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST SUB BUDGET CREATE img}
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST SUB BUDGET COPY img}
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST SUB BUDGET LINK img}
    Run Keyword And Continue On Failure    Element Should Not Be Visible    ${ASSIST SUB BUDGET UNLINK img}
