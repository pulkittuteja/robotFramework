...
*** Test Cases ***
TC101 - Assistant on Draft Shell - New
    ...
    Run Keyword And Continue On Failure    Element Should Be Visible    ${ASSIST PKIC REQUEST Link}/following-sibling::ul${ASSIST PKIC INCOMPLETE TEXT}
*** Keywords ***